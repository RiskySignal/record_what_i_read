...
1. 学习 “Predoo: Precision Testing of Deep Learning Operators”

   文章链接：https://dl.acm.org/doi/10.1145/3460319.3464843

2. 该工作尝试解决不同精度计算下，神经网络框架算子出现的误差，文章茶室提出一种算法将这种误差最大化。（从文章前面的描述以为它很牛逼，到算法部分一看没什么心意）；
